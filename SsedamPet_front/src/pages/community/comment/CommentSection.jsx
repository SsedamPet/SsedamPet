...
import { X, ChevronDown, ChevronUp, Home, Users, Image, User } from 'lucide-react';
    ...
    return (
        <div css={s.rootContainer}>
                        ...
                        <div css={s.commentWrapper}>
                            <div css={s.commentItem}>
                                ...
                                <div css={s.contentBox}>
                                    ...
                                    <div className="text">댓글1ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ</div>
                                    <div className="reply-toggle" onClick={() => setShowReplies(!showReplies)}>
                            ...
                            {showReplies && (
                                <div css={s.replyList}>
                                    <div css={s.replyItem}>
                                        <div css={s.avatar} style={{width:'30px', height:'30px'}} />
                                        <div css={s.contentBox}>
            ...
            <footer css={s.bottomNavBar}>
                <div css={s.navItem}><Home size={24}/>홈</div>
                <div css={s.navItem} style={{color:'#000'}}><Users size={24}/>커뮤니티</div>
                <div css={s.navItem}><Image size={24}/>건강기록</div>
                <div css={s.navItem}><User size={24}/>마이페이지</div>
            </footer>
        </div>
    );
};
